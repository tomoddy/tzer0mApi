...
/// </summary>
public class VisionService(ILogger<VisionService> logger, IConfiguration config, HttpClient httpClient)
{
    private readonly string _apiKey = config["SmarterMeter:GoogleVision:ApiKey"] ?? throw new InvalidOperationException("SmarterMeter:GoogleVision:ApiKey is not configured");
